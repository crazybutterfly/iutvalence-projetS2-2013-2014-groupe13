...
public class SpiesQuest extends Quests
{
    ...
    /**
     * Valeur par défaut de l'argent gagné par le joueur quand il atteint un checkpoint.
     */
    public int PRICE_WON_IF_CHECKPOINT_QUEST_DONE_DEFAULT = 200;
    
    /**
     * Valeur par défaut de l'argent gagné par l'équipe lorsque qu'un joueur atteint un checkpoint.
     */
    ...
    /**
     * Fonction mettant fin à une checkpointQuest et donnant de l'argent à l'équipe des Spies avec un supplément pour le joueur ayant atteint le checkpoint.
