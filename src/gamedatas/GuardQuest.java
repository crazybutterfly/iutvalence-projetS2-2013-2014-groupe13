...
public class GuardQuest extends Quests
{
    ...
    /**
     * Fonction donnant un gain de Coins au GuarChiefPlayer lorsque qu'un Guard tue un Spy.
     * Plus le garde tue de Spies sans mourir, plus le gain est important.
     * Première kill : 100 Coins. Deuxième kill : 200 Coins. Etc.
     * @param guardPlayer 
     */
    ...
    /**
     * Fonction réinitialisant le nombre de kill consécutive d'un Guard lorsqu'il meurt.
     * @param player
     */
